      ...
      <div className="bg-hld-surface border border-hld-cyan/30 rounded-lg shadow-xl w-full max-w-md overflow-hidden flex flex-col items-center p-6 mx-4">
        ...
        <div className="flex w-full gap-3">
          ...
          <button
            onClick={keepMine}
            disabled={busy}
            className="flex-1 py-2 px-4 bg-hld-yellow hover:bg-hld-yellow/80 text-black rounded font-mono uppercase tracking-wider text-xs transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {busy ? <Loader2 size={14} className="animate-spin" /> : null}
            Keep mine
          </button>
